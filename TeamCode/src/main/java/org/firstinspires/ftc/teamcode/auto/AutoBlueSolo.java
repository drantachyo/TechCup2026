...
@Configurable
@Autonomous(name = "🟦 Auto Solo 18 - BLUE", group = "Autonomous")
public class AutoBlueSolo extends OpMode {
    ...
    // ==========================================
    // 📍 КООРДИНАТЫ ДЛЯ СИНЕЙ СТОРОНЫ
    // ==========================================
    private final Pose targetPose = new Pose(0, 144, 0);
    private final Pose startPose = new Pose(26.65, 126.40, 2.437);
    private final Pose scorePose = new Pose(55.4, 79.63, 3.65);

    private final Pose NearBalls = new Pose(18.3, 83.76, 3.123);
    private final Pose MiddleBalls = new Pose(10.43, 57.7, 3.126);

    private final Pose gateOpen1 = new Pose(19, 65.6, Math.PI);
    private final Pose gatePickup1 = new Pose(12.567, 56.6, 2.57);

    private final Pose gateOpen2 = new Pose(19, 65.6, Math.PI);
    private final Pose gatePickup2 = new Pose(12.567, 56.6, 2.57);

    private final Pose FourthBall = new Pose(10.89, 36.86, Math.PI);
    private final Pose endPose = new Pose(49.3, 62, Math.PI);

    public static Pose controlPoint1 = new Pose(54.0, 59.0);
    public static Pose controlPoint2 = new Pose(44.0, 59.0);
    public static Pose controlPointGate2 = new Pose(44.0, 59.0);
    public static Pose controlPoint3 = new Pose(59.0, 37.0);
